...
def main():
    ...
    parser = HfArgumentParser((ModelArguments, DataTrainingArguments, TrainingArguments, VcasSampleArguments))
    ...
    if len(sys.argv) == 2 and sys.argv[1].endswith(".json"):
        ...
        model_args, data_args, training_args, sample_args = parser.parse_json_file(json_file=os.path.abspath(sys.argv[1]))
    else:
        # CHANGES #1: Add VcasSampleArguments to the argument parser
        # model_args, data_args, training_args = parser.parse_args_into_dataclasses()
        model_args, data_args, training_args, sample_args = parser.parse_args_into_dataclasses()
    ...
    # CHANGES #4: Substitute the original Trainer with VcasTrainer
    # trainer = Trainer(
    #     model=model,
    #     args=training_args,
